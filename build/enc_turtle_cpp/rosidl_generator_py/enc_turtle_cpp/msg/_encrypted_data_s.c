...
bool enc_turtle_cpp__msg__encrypted_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("enc_turtle_cpp.msg._encrypted_data.EncryptedData", full_classname_dest, 48) == 0);
  }
  enc_turtle_cpp__msg__EncryptedData * ros_message = _ros_message;
  {  // data
...
PyObject * enc_turtle_cpp__msg__encrypted_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("enc_turtle_cpp.msg._encrypted_data");
