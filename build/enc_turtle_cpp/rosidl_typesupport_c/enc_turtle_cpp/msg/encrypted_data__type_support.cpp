...
#include "enc_turtle_cpp/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _EncryptedData_type_support_symbol_names_t _EncryptedData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, enc_turtle_cpp, msg, EncryptedData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, enc_turtle_cpp, msg, EncryptedData)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_enc_turtle_cpp
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, enc_turtle_cpp, msg, EncryptedData)() {
  return &::enc_turtle_cpp::msg::rosidl_typesupport_c::EncryptedData_message_type_support_handle;
}
