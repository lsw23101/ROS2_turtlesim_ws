...
static const _EncryptedData_type_support_symbol_names_t _EncryptedData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_demo_controller, msg, EncryptedData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtle_demo_controller, msg, EncryptedData)),
  }
};
...
{
  return &::turtle_demo_controller::msg::rosidl_typesupport_cpp::EncryptedData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtle_demo_controller, msg, EncryptedData)() {
  return get_message_type_support_handle<turtle_demo_controller::msg::EncryptedData>();
}
